                    ...
                    <div className="right-nav">
                         <NavLink to='/cart'>
                              <div className="svg-contaienr border-2 border-green-500 p-3 rounded-full relative">
                                   ...
                                   <span className="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 h-6 w-6 bg-green-500 rounded-full flex justify-center items-center text-white">4</span>
                              </div>
                         </NavLink>
                    </div>
               </header>
